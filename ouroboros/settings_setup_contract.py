...
_MODEL_SLOTS = _rows(("slot", "stateKey", "settingKey", "inputId", "label", "note", "settingsInputId", "settingsToggleId"), (
    ...
    ("light", "lightModel", "OUROBOROS_MODEL_LIGHT", "light-model", "Лёгкая модель", "Быстрые резюме, лёгкие задачи и все глубокие субагенты (depth >=2). Укажите сильную модель для мощных дочерних агентов.", "s-model-light", "s-local-light"),
